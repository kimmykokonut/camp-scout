...
response = requests.get(f"https://www.recreation.gov/api/camps/availability/campground/{campground_id}/month?start_date=2026-04-01T00%3A00%3A00.000Z", headers=headers)
